...
function [mu_t,sigma_t] = execute_EKFSLAM(mu_t_1, sigma_t_1, u_t, z_t, c_t, R_t)
...
function [corrected_mu, corrected_sigma] = EKFSLAM_correction(mu_bar, sigma_bar, seen_landmark_mu, z_t, c_t, Q)
    N = 5;
    mu = mu_bar;
    sigma = sigma_bar;
    [rows , cols] = size(z_t);
